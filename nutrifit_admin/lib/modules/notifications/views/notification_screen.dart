...
class NotificationScreen extends StatelessWidget {
      ...
      return Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: _buildInputDecoration('Nhập tiêu đề (Ví dụ: Nhắc nhở uống nước)'),
                ),
                ...
                TextField(
                  ...
                  maxLines: 4,
                  style: GoogleFonts.outfit(color: TailAdminDesign.textMain),
                  decoration: _buildInputDecoration('Nhập nội dung tin nhắn gửi đến User...'),
                ),
                const SizedBox(height: 24),
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      style: GoogleFonts.outfit(color: TailAdminDesign.textMain),
                      items: ['Tất cả', 'User chưa tập hôm nay', 'User thừa cân', 'User VIP'].map((String value) {
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      controller.isLoading.value ? 'Đang xử lý...' : 'BẮN THÔNG BÁO NGAY',
          ...
          Text(
            ...
            style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold, color: TailAdminDesign.textMain),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(TailAdminDesign.radiusLg),
              border: Border.all(color: TailAdminDesign.border, style: BorderStyle.none),
            ),
            child: Center(
              child: Text(
  ...
  Widget _buildLabel(String text) {
    return Padding(
      ...
      child: Text(
        text,
        style: GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w500, color: TailAdminDesign.textMain),
      ),
    );
  }

...
class NavigationController extends GetxController {
  ...
  void onInit() {
    ...
    // Khởi tạo các controller dùng chung
...
class AdminSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(right: BorderSide(color: TailAdminDesign.border, width: 1)),
      ),
      child: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildSectionTitle('MENU', navBarController.isSidebarCollapsed.value),
                _SidebarItem(
                ...
                _SidebarItem(
                  ...
                  isCollapsed: navBarController.isSidebarCollapsed.value,
                  hasSubmenu: true,
                  isExpanded: navBarController.expandedMenu.value == 'Dinh dưỡng',
                  onTap: () {
                    if (navBarController.isSidebarCollapsed.value) {
                ...
                _SidebarItem(
                  ...
                  isCollapsed: navBarController.isSidebarCollapsed.value,
                  hasSubmenu: true,
                  isExpanded: navBarController.expandedMenu.value == 'Bài tập',
                  onTap: () {
                    if (navBarController.isSidebarCollapsed.value) {
                ...
                _buildSectionTitle('HỖ TRỢ', navBarController.isSidebarCollapsed.value),
                _SidebarItem(
  ...
  Widget _buildSectionTitle(String title, bool isCollapsed) {
    return Padding(
      ...
      child: isCollapsed 
        ? Center(child: Container(width: 20, height: 1, color: TailAdminDesign.border))
        : Text(
            title,
            style: GoogleFonts.outfit(
              fontSize: 12,
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    widget.icon,
                    color: widget.isActive ? TailAdminDesign.brand500 : (_isHovered ? TailAdminDesign.textMain : TailAdminDesign.textMuted),
                    size: 22,
                  ),
                    ...
                    if (widget.hasSubmenu)
                      AnimatedRotation(
                        ...
                        child: Icon(
                          ...
                          size: 18,
                          color: _isHovered ? TailAdminDesign.textMain : TailAdminDesign.textMuted,
                        ),
                      ),
                  ],
                ],
...
class AdminHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => Container(
      ...
      decoration: BoxDecoration(
        color: TailAdminDesign.bgCard,
        border: Border(bottom: BorderSide(color: TailAdminDesign.border, width: 1)),
      ),
      child: Row(
        children: [
          IconButton(
            ...
            icon: Icon(
              navBarController.isSidebarCollapsed.value ? Icons.menu_open_rounded : Icons.menu_rounded,
              color: TailAdminDesign.textMain,
            ),
          ),
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: TailAdminDesign.bgCard, width: 2),
                  ),
                ),
              ),
            ],
            ...
            child: MouseRegion(
              ...
              child: Row(
                children: [
                  ...
                  Icon(Icons.keyboard_arrow_down_rounded, color: TailAdminDesign.textMuted, size: 20),
                ],
              ),
            ),
          ),
  ...
  PopupMenuItem<int> _buildDropdownItem(int value, IconData icon, String title, {bool isDanger = false}) {
    return PopupMenuItem<int>(
      value: value,
      child: Row(
        children: [
          Icon(
            icon,
            size: 18,
            color: isDanger ? TailAdminDesign.danger : TailAdminDesign.textMuted,
          ),
          const SizedBox(width: 12),
          Text(
            title,
            style: GoogleFonts.outfit(
              fontSize: 14,
              color: isDanger ? TailAdminDesign.danger : TailAdminDesign.textMain,

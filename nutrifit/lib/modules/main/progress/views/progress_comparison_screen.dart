      ...
      body: Padding(
        ...
        child: Column(
          children: [
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: _buildPhotoBox(context, isBefore: true),
                        ),
                        SizedBox(width: 15),
                        Expanded(
                          child: _buildPhotoBox(context, isBefore: false),
                        ),
                      ],
                    ),
                    SizedBox(height: 30),
                        ...
                        () => Row(
                          ...
                          children: [
                            ...
                            _buildStatItem(
                              context,
                              'Kết quả',
                              controller.weightDifferenceText,
                              Colors.orange,
                            ),
                          ],
                        ),
            ...
            Obx(
              () =>
                  controller.beforePhoto.value != null &&
                      controller.afterPhoto.value != null
                  ? Padding(
        ...
        Get.bottomSheet(
          Container(
            ...
            child: Column(
              children: [
                Text(
                  isBefore ? 'Chọn ảnh Trước' : 'Chọn ảnh Sau',
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Poppins',

      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              IconButton(
                icon: const Icon(Icons.tune, color: Color(0xFF1D1517)),
                onPressed: () => _hienThiSuaMucTieu(context, sleepController),
              ),
              IconButton(
                icon: const Icon(Icons.health_and_safety, color: Color(0xFF1D1517)),
                onPressed: () => sleepController.syncWithHealthFit(),
              ),
              IconButton(
                icon: const Icon(Icons.add, color: Color(0xFF1D1517)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    trailing: const Icon(Icons.edit, color: Color(0xFFC050F6)),
                    onTap: () async {
        ...
        children: [
          SvgPicture.asset(
            ...
            errorBuilder: (context, error, stackTrace) =>
                const Icon(Icons.alarm, color: Color(0xFFC050F6), size: 30),
          ),

...
class _AddSleepScheduleScreenState extends State<AddSleepScheduleScreen> {
  ...
  void initState() {
    ...
    if (widget.existingSchedule != null) {
      ...
      alarmTime = DateTime.now().add(Duration(hours: 8));
    }
  }
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(color: Theme.of(context).brightness == Brightness.dark ? Colors.grey.shade500 : Color(0xFFC6C4D3), fontSize: 14),
                ),
              ),
            ),
            SizedBox(height: 30),
